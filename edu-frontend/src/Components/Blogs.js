                    ...
                    <div className="row pb-3">
                        <div className="col-lg-4 mb-4">
                            <div className="card border-0 shadow-sm mb-2">
                                ...
                                <div className="card-body bg-light text-center p-4">
                                    ...
                                    <p>
                                        Sed kasd sea sed at elitr sed ipsum
                                        justo, sit nonumy diam eirmod, duo et
                                        sed sit eirmod kasd clita tempor dolor
                                        stet lorem. Tempor ipsum justo amet
                                        stet...
                                    </p>
                                    <a
                                        href="#"
                        ...
                        <div className="col-lg-4 mb-4">
                            <div className="card border-0 shadow-sm mb-2">
                                <img
                                    className="card-img-top mb-2"
                                    src="templateAssets/img/blog-2.jpg"
                                    alt=""
                                />
                                <div className="card-body bg-light text-center p-4">
                                    <h4 className="">
